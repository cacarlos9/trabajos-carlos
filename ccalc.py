...
# Botón de limpiar (C)
tk.Button(ventana, text='C', width=5, height=2, command=limpiar_pantalla).grid(row=fila, column=1)
tk.Button(ventana, text='=', width=5, height=2, command=calcular_resultado).grid(row=fila, column=0)
